...
def menu():
    ...
    pygame.draw.rect(screen, colors.get("limeGreen"), Button_Game1)
    pygame.draw.rect(screen, colors.get("limeGreen"), Button_Game2)
    pygame.draw.rect(screen, colors.get("limeGreen"), Button_score)
    pygame.draw.rect(screen, colors.get("limeGreen"), Button_exit)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if Button_menu.collidepoint((mx, my)):
                    return False 
                if Button_instruct.collidepoint((274, 150, 125, 40)):
                    Instructions()
