...
#use arrays
#help from youtube
#use images for x and o because i couldnt figure out how to render the lines
#tic tac toe 2
...
# Images
X_IMAGE = pygame.transform.scale(pygame.image.load("pygamefiles/images/x.png"), (80, 80))
O_IMAGE = pygame.transform.scale(pygame.image.load("pygamefiles/images/o.png"), (80, 80))

# Fonts
END_FONT = pygame.font.SysFont('comic sans', 40)
